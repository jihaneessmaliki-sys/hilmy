    ...
    <>
      ...
      <main className="flex-1 flex items-center justify-center py-32 px-4">
        <div className="text-center max-w-lg">
          <h1 className="font-heading text-4xl font-light text-green-deep mb-6">Notre manifeste</h1>
          <p className="text-muted-foreground mb-8">Cette page arrive bientôt.</p>
